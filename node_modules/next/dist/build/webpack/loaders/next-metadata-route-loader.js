...
const _nextmetadataimageloader = require("./next-metadata-image-loader");
...
async function getDynamicSiteMapRouteCode(resourcePath, page, loaderContext) {
    ...
    const exportNames = await (0, _nextmetadataimageloader.getNamedExports)(resourcePath, loaderContext);
